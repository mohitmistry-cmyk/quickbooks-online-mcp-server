...
const toolDescription = "Search received customer payments in QuickBooks Online. Use this for recently paid invoices and payment-date questions; linked invoice IDs are present in payment LinkedTxn data. Date ranges require txn_date_from and txn_date_to in YYYY-MM-DD format.";
