...
const toolDescription = "Search purchases and expenses in QuickBooks Online. Use criteria entries with field, operator, and value. Numeric/date comparisons are supported and are safely evaluated when QBO does not accept them.";
