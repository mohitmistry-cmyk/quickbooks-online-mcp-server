...
const toolDescription = "Search invoices in QuickBooks Online. Put filters inside criteria.filters. Numeric/date comparisons are supported; use numeric amounts without currency symbols and ISO YYYY-MM-DD dates.";
